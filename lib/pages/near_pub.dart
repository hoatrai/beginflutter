...
class NearPubPage extends StatefulWidget {
  final int userId;
  ...
  @override
  State<NearPubPage> createState() => _NearPubPageState();
}

class _NearPubPageState extends State<NearPubPage>
...
// 2️⃣ Test user
      ...
      if (mounted) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          _fitBoundsOnce(); // fit bounds cho tất cả user
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => ChatPage(
                        username: widget.username,          // của bạn
                        userId: widget.userId,              // của bạn
                        targetUser: targetUsername,         // người muốn chat
                        targetId: int.parse(targetUserId),  // convert sang int
                        targetAvatar: user['avatar'] ?? "", // nếu có avatar
